...
class AttendeesControllerTest < ActionController::TestCase
  ...
  test "should create attendee" do
    assert_difference('Attendee.count') do
      post :create, attendee: { enforcer: @attendee.enforcer, first_name: @attendee.first_name, handle: @attendee.handle, last_name: @attendee.last_name }
    end
  ...
  test "should update attendee" do
    put :update, id: @attendee, attendee: { enforcer: @attendee.enforcer, first_name: @attendee.first_name, handle: @attendee.handle, last_name: @attendee.last_name }
    assert_redirected_to attendee_path(assigns(:attendee))
  end
